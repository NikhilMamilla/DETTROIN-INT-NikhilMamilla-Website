...
const POSTS = [
  {
    ...
    excerpt:
      'Choosing the right school is one of the most important decisions parents make for their child’s future. A good school not only builds strong academics but also shapes character and confidence.',
    image: blog1,
    readTime: '4 min read',
  },
  {
    ...
    excerpt:
      'Primary education plays a crucial role in shaping a child’s academic journey and overall development. It is during these early years that lifelong learning habits are formed.',
    image: blog2,
    readTime: '3 min read',
  },
  {
    ...
    excerpt:
      'Choosing the right school is one of the most important decisions for parents who want the best future for their children. A good school combines strong academics with holistic growth.',
    image: blog3,
    readTime: '5 min read',
  },
]
...
export default function Blog() {
  return (
    <>
      <PageHero title="School Blog" crumb="Blog" />
            ...
            <Reveal key={post.title} delay={i * 100}>
              <article className="group h-full overflow-hidden rounded-2xl bg-white shadow-card transition hover:-translate-y-1 hover:shadow-soft">
                ...
                <div className="p-6">
                  ...
                  <h2 className="mt-3 text-lg font-bold leading-snug text-primary-900">
                    {post.title}
                  </h2>
